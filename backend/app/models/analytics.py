from sqlalchemy import Column, Integer, String, DateTime, Float, Text, Index, ForeignKey
...
class UserBehavior(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id"), index=True)  # 用户 ID
    ...
    session_id = Column(String(100), nullable=True)  # 会话 ID
